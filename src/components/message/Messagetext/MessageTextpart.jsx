  ...
  return (
    <div>
      <div className="block mt-6  overflow-hidden pb-4 text-center w-fit m-auto">
        <div className="float-left p-1 border border-df w-24 h-24 rounded-full shadow-md bg-white">
          <img
        ...
        <div className="float-left p-1 border border-df w-24 h-24 rounded-full shadow-md bg-white  ml-[-30px]">
          <img
