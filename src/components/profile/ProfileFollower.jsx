...
const ProfileFollower = () => {
  ...
  return (
    <div>
      <div className="  px-10 py-6 bg-white rounded-lg w-full">
        ...
        {/* Friends List */}
        <div className="grid grid-cols-2 gap-4 text-[#555] text-sm mt-6">
          {/* Friend Item 1 */}
          {userData.map((user, index) => (
            <div
              key={index}
              className="flex items-center gap-3 hover:bg-gray-100 transition p-2 rounded-md"
            >
              <div className="w-[76px] h-[76px] rounded-lg overflow-hidden border-df  ">
                <img
